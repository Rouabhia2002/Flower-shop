...
app.post('/api/register', async (req, res) => {
  ...
  try {
    ...
    const token = jwt.sign({ id: newUser._id, username: newUser.username }, 'your_jwt_secret', { expiresIn: '1h' });
...
// Route to handle placing orders (unprotected for demonstration)
